...
# #5-masala 
# #   
# animals = ['it', 'mushuk', 'quyon']
# animals.append('sigir')
# print(animals)
# animals.sort()
# print(animals)
# print(len(animals))
# print('mushuk' in animals)
# print(animals.index('quyon'))
...
# countries = ['O‘zbekiston', 'Qozog‘iston', 'Rossiya']
# countries.append('Xitoy')
# print(countries)
# countries.sort()
# print(countries)
# print(len(countries))
# print('Rossiya' in countries)
# print(countries.index('Qozog‘iston'))
...
# print(beverages)
# print(len(beverages))
# print('Coffee' in beverages)
# print(beverages.index('Juice'))
...
# print(hobbies)
# print(len(hobbies))
# print('Traveling' in hobbies)
# print(hobbies.index('Cooking'))

# #18-masala

# cart = [ 'non', 'sut', 'tuxum', "go'sht"]
# cart.append('piyoz')
# print(cart)
# cart.sort()
# print(cart)
